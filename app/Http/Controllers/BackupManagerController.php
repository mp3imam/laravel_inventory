...
class BackupManagerController extends Controller
{
    ...
    public function createBackup(Request $request)
    {
        ...
        LogActivity::addToLog("Backup Database");

        return redirect()->back();
    }

    public function restoreOrDeleteBackups(Request $request)
    {
        $mailBody = '';
        $messages = [];
        ...
        Session::flash('messages', $messages);
        LogActivity::addToLog("Merestore Database");
    ...
    public function download($file, Request $request)
    {
        ...
        $file = Storage::disk(config('backupmanager.backups.disk'))
                ...
                // ->getAdapter()
                ->path($path);
        LogActivity::addToLog("Mendownload Database");
