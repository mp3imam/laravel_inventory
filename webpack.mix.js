...
//         folder.src + "js/pages/apps-nft-auction.init.js",
//         folder.src + "js/pages/apps-nft-create.init.js",
//         folder.src + "js/pages/apps-nft-explore.init.js",
//         folder.src + "js/pages/apps-nft-item-details.init.js",
//         folder.src + "js/pages/apps-nft-ranking.init.js",
//         folder.src + "js/pages/api-key.init.js",
...
//         folder.src + "js/pages/crm-deals.init.js",
...
//         folder.src + "js/pages/dashboard-nft.init.js",
...
//         folder.src + "js/pages/flag-input.init.js",
...
//         folder.src + "js/pages/job-application.init.js",
//         folder.src + "js/pages/job-candidate-grid.init.js",
//         folder.src + "js/pages/job-candidate-lists.init.js",
//         folder.src + "js/pages/job-companies-lists.init.js",
//         folder.src + "js/pages/job-grid-list.init.js",
//         folder.src + "js/pages/job-lading.init.js",
//         folder.src + "js/pages/job-list.init.js",
//         folder.src + "js/pages/job-statistics.init.js",
...
//         folder.src + "js/pages/nft-landing.init.js",
//         folder.src + "js/pages/particles.app.js",
//         folder.src + "js/pages/password-addon.init.js",
//         folder.src + "js/pages/passowrd-create.init.js",
...
//         folder.src + "js/pages/todo.init.js",
...
mix.combine('resources/js/pages/crm-companies.init.js', folder.dist_assets + "js/pages/crm-companies.init.js");
mix.combine('resources/js/pages/crm-contact.init.js', folder.dist_assets + "js/pages/crm-contact.init.js");
mix.combine('resources/js/pages/ecommerce-order.init.js', folder.dist_assets + "js/pages/ecommerce-order.init.js");
mix.combine('resources/js/pages/ecommerce-customer-list.init.js', folder.dist_assets + "js/pages/ecommerce-customer-list.init.js");
mix.combine('resources/js/pages/ecommerce-cart.init.js', folder.dist_assets + "js/pages/ecommerce-cart.init.js");
mix.combine('resources/js/pages/tasks-list.init.js', folder.dist_assets + "js/pages/tasks-list.init.js");
mix.combine('resources/js/pages/invoicecreate.init.js', folder.dist_assets + "js/pages/invoicecreate.init.js");
mix.combine('resources/js/pages/invoicedetails.js', folder.dist_assets + "js/pages/invoicedetails.js");
mix.combine('resources/js/pages/invoiceslist.init.js', folder.dist_assets + "js/pages/invoiceslist.init.js");
mix.combine('resources/js/pages/ticketlist.init.js', folder.dist_assets + "js/pages/ticketlist.init.js");
mix.combine('resources/js/pages/listjs.init.js', folder.dist_assets + "js/pages/listjs.init.js");
