                    ...
                    <div data-simplebar style="max-height: 410px;" class="p-3 pt-0">
                        <div class="acitivity-timeline acitivity-main">
                            ...
                            <div class="acitivity-item py-3 d-flex">
                                ...
                                <div class="flex-grow-1 ms-3">
                                    <h6 class="mb-1 lh-base">Today offers by <a href="{{URL::asset('/apps-ecommerce-seller-details')}}" class="link-secondary">Digitech Galaxy</a></h6>
                        ...
                        <div class="mt-3">
                            ...
                            <div class="row align-items-center g-2">
                                ...
                                <div class="col">
                                    <div class="p-1">
                                        <div class="progress animated-progress progress-sm">
                                            <div class="progress-bar bg-primary" role="progressbar" style="width: 4.98%" aria-valuenow="4.98" aria-valuemin="0" aria-valuemax="100"></div>
                                        </div>
                                    </div>
                                </div>
