...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            ...
            <div class="card-body">
                <div class="col-xxl-6">
                    <form action="{{ route('berita.save') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @Method('POST')
                        <div class="row mb-3">
                            <div class="col-lg-3">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-lg-9">
                                <textarea class="form-control" id="meassageInput" name="berita" rows="3" placeholder="Berita"></textarea>
                            </div>
